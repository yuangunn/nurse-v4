...
> **최신 버전: v4.13.1** | [전체 릴리스 목록](https://github.com/yuangunn/nurse-v4/releases) · [변경 이력](CHANGELOG.md)

#### 🪟 Windows
| 파일 | 용도 | 크기 |
|------|------|:----:|
| [**NurseScheduler_Setup_v4.13.1.exe**](https://github.com/yuangunn/nurse-v4/releases/download/v4.13.1/NurseScheduler_Setup_v4.13.1.exe) | 설치 마법사 (권장) | ~166 MB |
| [**NurseScheduler_v4_portable.zip**](https://github.com/yuangunn/nurse-v4/releases/download/v4.13.1/NurseScheduler_v4_portable.zip) | 포터블 (설치 불필요) | ~244 MB |

#### 🍎 macOS (Apple Silicon)
| 파일 | 용도 | 크기 |
|------|------|:----:|
| [**NurseScheduler_v4_mac_arm64.dmg**](https://github.com/yuangunn/nurse-v4/releases/download/v4.13.1/NurseScheduler_v4_mac_arm64.dmg) | 디스크 이미지 (권장) | ~226 MB |
| [**NurseScheduler_v4_mac_arm64.zip**](https://github.com/yuangunn/nurse-v4/releases/download/v4.13.1/NurseScheduler_v4_mac_arm64.zip) | 포터블 (.app) | ~200 MB |
...
build.bat
```
결과물: `dist/installer/NurseScheduler_Setup_v4.13.1.exe`, `dist/NurseScheduler_v4_portable.zip`
