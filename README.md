...
- **자동 회귀 테스트 153건** — 핵심 제약·두 솔버의 결과 동등성·완화·임산부 모성보호·공휴일 자동계산을 자동 검증해, 기능을 추가해도 기존 동작이 깨지지 않도록 유지합니다. push/PR 마다 CI 가 돌립니다.

---

## 다운로드

> **최신 버전: v4.11.2** | [전체 릴리스 목록](https://github.com/yuangunn/nurse-v4/releases) · [변경 이력](CHANGELOG.md)

#### 🪟 Windows
| 파일 | 용도 | 크기 |
|------|------|:----:|
| [**NurseScheduler_Setup_v4.11.2.exe**](https://github.com/yuangunn/nurse-v4/releases/download/v4.11.2/NurseScheduler_Setup_v4.11.2.exe) | 설치 마법사 (권장) | ~166 MB |
| [**NurseScheduler_v4_portable.zip**](https://github.com/yuangunn/nurse-v4/releases/download/v4.11.2/NurseScheduler_v4_portable.zip) | 포터블 (설치 불필요) | ~244 MB |

#### 🍎 macOS (Apple Silicon)
| 파일 | 용도 | 크기 |
|------|------|:----:|
| [**NurseScheduler_v4_mac_arm64.dmg**](https://github.com/yuangunn/nurse-v4/releases/download/v4.11.2/NurseScheduler_v4_mac_arm64.dmg) | 디스크 이미지 (권장) | ~226 MB |
| [**NurseScheduler_v4_mac_arm64.zip**](https://github.com/yuangunn/nurse-v4/releases/download/v4.11.2/NurseScheduler_v4_mac_arm64.zip) | 포터블 (.app) | ~200 MB |
...
build.bat
```
결과물: `dist/installer/NurseScheduler_Setup_v4.11.2.exe`, `dist/NurseScheduler_v4_portable.zip`
...
│   └── assets/              # 아이콘·이미지
├── tests/                   # pytest 회귀 153건 (제약·진단·CP-SAT 동등성·충돌·야간전담·레이스·완화·모성보호·공휴일·오프특근·쉴코드수급·주휴블록)
